...
const HeaderTable: React.FC<{ page: number; totalPages: number; date: string }> = ({ page, totalPages, date }) => (
    <div className="border border-gray-500 border-2 overflow-hidden">
      <table className="w-full border-collapse">
        <tbody>
          ...
          <tr>
            <td colSpan={3} className="p-2 border border-gray-500">FECHA DE ACTUALIZACIÓN: {date}</td>
          </tr>
        </tbody>
      </table>
    </div>
